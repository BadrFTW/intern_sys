...
<!-------------------SIDEBAR------------------>
		...
		<div id = "sidecontent" class = "well pull-right">
			<div class = "alert alert-info">Les Stages</div>
			<button type = "button" id = "add_activity" class = "btn btn-success"><span class = "glyphicon glyphicon-plus"></span> Ajouter un stage</button>
				...
				<div class = "modal-dialog" role = "document">
					<div class = "modal-content ">
						<div class = "modal-body">
							<center><label class = "text-danger">Êtes-vous sûr(e) de vouloir supprimer cet enregistrement ?</label></center>
							<br />
			...
			<div id = "act_form" style = "display:none;" class = "panel panel-default">
				<div  class = " panel-heading" >	
					<div class = "alert alert-success">Ajouter un Stages/nouveau</div>
