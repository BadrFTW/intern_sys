...
?>
	...
	<div class = "container-fluid" id = "content">	
		<div class = "row" style = "margin-top:-120px;">	
				...
				<ul class="nav nav-tabs">
					...
					<li><a href="#activities" data-toggle = "tab">Les Stages</a></li>
				</ul>
				<br />
	...
	<nav class = "navbar-default" id = "footer">
		<label class = "navbar-brand pull-right">&copy;
Système de gestion des offres des stages<?php echo date('Y', strtotime('+8 HOURS'))?></label>
