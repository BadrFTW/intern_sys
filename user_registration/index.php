...
<tr>
<td>Genre</td>
<td><input type="radio" name="gender" value="Homme" <?php if(isset($_POST['gender']) && $_POST['gender']=="Male") { ?>checked<?php  } ?>> Homme
<input type="radio" name="gender" value="Femme" <?php if(isset($_POST['gender']) && $_POST['gender']=="Female") { ?>checked<?php  } ?>> Femme
</td>
</tr>
<tr>
<td colspan=2>
